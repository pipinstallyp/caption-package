...
def init_argparse() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--model_order',
                        help='Perform captioning/fallback using this order (default: coca,git,blip,qwen)',
                        default='coca,git,blip,qwen',
                        )
    ...
    parser.add_argument('--qwen_pass',
                        help='Perform a Qwen model pass',
                        action='store_true',
                        )
    parser.add_argument('--qwen_chat_text',
                        help='Text to be used for Qwen model chat',
...
def main() -> None:
    ...
    if config.qwen_pass:
        ...
        config._qwen = QwenCap(config.device)
